                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="{{ asset('tampilan/assets/img/portfolio/aula.png') }}" alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src="{{ asset('tampilan/assets/img/portfolio/aula2.png') }}" alt="">
                                </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="portfolio-description">
                            ...
                            <p>
                                Aula Pondok adalah fasilitas utama yang digunakan untuk berbagai kegiatan komunitas di pondok. Ruangan ini dirancang untuk mendukung acara seperti pertemuan, seminar, dan kegiatan bersama lainnya. Aula ini dilengkapi dengan fasilitas audio-visual modern dan ruang yang cukup untuk menampung banyak peserta. Selain berfungsi sebagai tempat berkumpul, aula juga menciptakan suasana yang kondusif untuk kegiatan edukatif dan sosial, memperkuat rasa kebersamaan di antara penghuni pondok.
                            </p>
                        </div>
                    </div>
