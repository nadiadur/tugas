                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="{{ asset('tampilan/assets/img/portfolio/sholat.png') }}" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="portfolio-description">
                            <h2>Detail Pelaksanaan</h2>
                            <p>
                                Sholat berjama'ah adalah kegiatan rutin yang dilakukan oleh penghuni pondok di aula pondok. Kegiatan ini berlangsung setiap hari dan merupakan waktu khusus untuk berkumpul bersama dalam ibadah sholat. Selain sebagai kewajiban agama, sholat berjama'ah juga memperkuat ikatan sosial di antara penghuni pondok dan menciptakan rasa kebersamaan. Selama pelaksanaan, aula pondok disiapkan dengan baik untuk memastikan kenyamanan dan khusyuknya ibadah.
                            </p>
                        </div>
                    </div>
