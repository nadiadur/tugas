                        ...
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="{{ asset('tampilan/assets/img/portfolio/dapur1.png') }}" alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src="{{ asset('tampilan/assets/img/portfolio/dapur2.png') }}" alt="">
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            ...
                            <ul>
                                ...
                                <li><strong>Lokasi</strong>: Dapur Pondok</li>
                                <li><strong>Tanggal </strong>: 16 Januari, 2024</li>
                            </ul>
                        </div>
                        <div class="portfolio-description">
                            <h2>Deskripsi Pelaksanaan</h2>
                            <p>
                                Dapur pondok merupakan fasilitas penting yang mendukung kebutuhan makan sehari-hari bagi seluruh penghuni pondok. Dapur ini dilengkapi dengan peralatan memasak yang memadai dan area persiapan makanan yang bersih dan terorganisir. Selain menyediakan makanan bergizi, dapur juga berfungsi sebagai tempat kegiatan memasak bersama, yang mempererat hubungan antar penghuni pondok dan menciptakan suasana kekeluargaan.
                            </p>
                        </div>
                    </div>
