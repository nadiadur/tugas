<section id="portfolio" class="portfolio">
    <div class="container">
      ...
      <div class="row portfolio-container">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <div class="portfolio-wrap">
            <img src="tampilan/assets/img/portfolio/keg1.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h3><a href="tampilan/assets/img/portfolio/keg1.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 2">Idhul Adha</a></h3>
              <div>
                <a href="tampilan/assets/img/portfolio/keg1.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Idhul Adha"><i class="bi bi-plus"></i></a>
                <a href="{{ route('details.detail3') }}" title="Details"><i class="bi bi-link"></i></a>
              </div>
            </div>
          </div>
        </div>
  ...
  <section id="faq" class="faq section-bg">
    <div class="container">
      ...
      <ul class="faq-list">
        ...
        <li>
          <div data-bs-toggle="collapse" class="collapsed question" href="#faq1">Bagaimana cara mendaftar ke Ponpes API? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
          <div id="faq1" class="collapse" data-bs-parent=".faq-list">
            <p>
              Pendaftaran dapat dilakukan dengan datang ke kantor Ponpes API dengan membawa dokumen yang tertera di brosur.
            </p>
          </div>
        </li>

        <li>
          <div data-bs-toggle="collapse" href="#faq2" class="collapsed question">Apa saja fasilitas yang disediakan oleh Ponpes API? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
          <div id="faq2" class="collapse" data-bs-parent=".faq-list">
            <p>
              Ponpes API menyediakan asrama, ruang belajar, mushola, almari, dan Aula untuk mendukung kegiatan belajar dan mengajar.
            </p>
          </div>
        </li>

        <li>
          <div data-bs-toggle="collapse" href="#faq3" class="collapsed question">Apakah ada biaya pendidikan di Ponpes API?  <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
          <div id="faq3" class="collapse" data-bs-parent=".faq-list">
            <p>
              Dalam ponpes Asrama Perguruan Islam ini tidak memungut biaya apapun, kalian hanya datang ke kantor ponpes dan membawa berkas yang diperlukan.
            </p>
          </div>
        </li>
        ...
        <li>
          <div data-bs-toggle="collapse" href="#faq6" class="collapsed question">Kitab apa saja yang dipelajari di popes API <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
          <div id="faq6" class="collapse" data-bs-parent=".faq-list">
            <p>
              Pada ponpes API mempelajari 2 kitab yaitu, kitab Tafsir dan kitab Fathul Qorib.
            </p>
          </div>
        </li>
