    ...
    <div id="auth">
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div style="text-align: left;" mr-5>
                        <a href="index.html"><img src="{{ asset('template/assets/images/logo/logo.png') }}" alt="Logo"  width="80" height="auto" style="vertical-align: top; margin-left: 70px; margin-bottom: 30px;" ></a>
                    </div>
